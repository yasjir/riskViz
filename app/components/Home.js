...
export default class Home extends Component {
  static propTypes = {
    getGridState: PropTypes.func.isRequired,
    getSimulation8hResults : PropTypes.func.isRequired,
    getSimulationsBaseDateTime: PropTypes.func.isRequired,
    data: PropTypes.object.isRequired
  };

  componentWillMount(){
    this.props.getSimulationsBaseDateTime();
    this.props.getSimulation8hResults(0);
  }
  ...
  render() {
    ...
    //     };
        ...
        const { getGridState, getSimulation8hresults,data } = this.props;
        ...
        return(
          <div>
            <div className="row">
              ...
              <div className="col-md-6">
                <GridModel data={data.grid_state}></GridModel>
              </div>
            </div>
            <div className="row">
              <div className="col-md-6">
                <button onClick={getGridState}>Get grid</button>
              </div>
            </div>
          </div>
        );
